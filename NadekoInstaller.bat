...
bitsadmin.exe /transfer "Downloading Nadeko (Latest)" /priority high https://github.com/rumlefisk/NadekoBot/raw/master/scripts/Latest.bat "%FILENAME%"
...
bitsadmin.exe /transfer "Downloading Nadeko (Stable)" /priority high https://github.com/rumlefisk/NadekoBot/raw/master/scripts/Stable.bat "%FILENAME%"
...
bitsadmin.exe /transfer "Downloading Nadeko Run (normal)" /priority high https://github.com/rumlefisk/NadekoBot/raw/master/scripts/NadekoRun.bat "%FILENAME%"
ECHO.
...
bitsadmin.exe /transfer "Downloading Nadeko Auto-Run" /priority high https://github.com/rumlefisk/NadekoBot/raw/master/scripts/NadekoAutoRun.bat "%FILENAME%"
ECHO.
